...
/**
 * Callback implementations for KIA AI Question Generator
 *
 ...
 */
function qbank_kia_generator_required_capabilities() {
    return ['moodle/question:add', 'moodle/course:viewhiddenactivities', 'qbank/kia_generator:generatequestions'];
}
 ...
 */
function qbank_kia_generator_extend_navigation_course(navigation_node $navigation, stdClass $course, context $context) {
    if (!isloggedin() || isguestuser() || !has_all_capabilities(qbank_kia_generator_required_capabilities(), $context)) {
        return;
    }

    $navigation->add(
        get_string('title', 'qbank_kia_generator'),
 ...
 */
function qbank_kia_generator_get_course_resources(stdClass $course) {
 ...
 */
function qbank_kia_generator_get_fileinfo_for_resource(int $resourceid) {
    $fs = get_file_storage();
 ...
 */
function qbank_kia_generator_create_question_category(int $courseid, string $resourcedescription) {
    global $DB;

    $record = [
        'name'       => 'kia_generator ('.date('d/m/Y H:i:s').')',
 ...
 */
function qbank_kia_generator_get_resource_names_string($resources) {
 ...
 */
function qbank_kia_generator_create_question(string $name, stdClass $question, stdClass $category) {
    global $USER, $DB;
 ...
 * @param stdClass $category Information about the category and context
 */
function qbank_kia_generator_add_description(string $name, string $text, stdClass $category) {
    global $USER, $DB;
